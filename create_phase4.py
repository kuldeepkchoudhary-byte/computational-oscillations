...
files["src/coupled_oscillators/spin_dynamics.py"] = '''\
...
files["tests/test_spin_dynamics.py"] = '''\
import numpy as np
...
write_notebook("08_spin_dynamics/01_single_spin_llg.ipynb", "Single Spin LLG", "## Theory\nPrecession and damping.", '''import numpy as np
...
write_notebook("08_spin_dynamics/02_coupled_spins.ipynb", "Coupled Spins", "## Theory\nTwo interacting spins.", "# To be filled")
write_notebook("08_spin_dynamics/03_spin_chain.ipynb", "Spin Chain", "## Theory\nSpin waves in 1D chain.", "# To be filled")
write_notebook("08_spin_dynamics/04_spin_wave_dispersion.ipynb", "Spin Wave Dispersion", "## Theory\nExtracting omega(k).", "# To be filled")
